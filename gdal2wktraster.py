...
# and option -w, --wktraster-version is ignored, if specified.
g_rt_version = 0
...
def parse_command_line():
    ...
    grp_u.add_option("-w", "--wktraster-version", dest="version",
                     action="store", type="int", default=g_rt_version, 
                     help="specify version of WKT Raster protocol, default is 0; "
